...
export const metadata: Metadata = {
  ...
  alternates: { canonical: new URL('/', metadataBase).href },
  openGraph: { url: new URL('/', metadataBase).href, title: site.seo.title, description: site.seo.description, locale: 'pt_BR', type: 'website' },
