...
export const site = {
  ...
  images: { hero: '/images/joelane-retrato-ensaio.webp', presentation: '/images/joelane-apresentacao-estudio.webp', about: '/images/joelane-cuidado-paciente.webp', evaluation: '/images/joelane-avaliacao-consultorio.jpg', beauty: '/images/joelane-cuidado.webp' },
  ...
  seo: { title: 'Dra. Joelane Bittencourt | Harmonização Facial em Salvador', description: 'Harmonização Orofacial e rejuvenescimento facial em Salvador com a Dra. Joelane Bittencourt. Avaliação individualizada e planejamento para o seu rosto.', url: 'https://drajoelanebittencourt.com.br' },
};
