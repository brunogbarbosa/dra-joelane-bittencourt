...
As quatro avaliações aparecem em um carrossel com estrelas, iniciais e links para as fontes. Os textos são cadastrados localmente: não há sincronização automática com o Google. A passagem automática pausa durante interação e fica desativada com `prefers-reduced-motion`.
